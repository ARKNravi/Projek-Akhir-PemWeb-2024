        ...
        <div class="col-lg-9">
            <div id="crud" class="section">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>CRUD adalah singkatan dari Create, Read, Update, dan Delete, yang merupakan operasi dasar yang diperlukan dalam aplikasi manajemen data. 
            ...
            <div id="create" class="section">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>Create sendiri merupakan pengguna dapat menambahkan catatan atau entri baru ke database. Fungsi ini meliputi memasukkan data ke dalam 
            ...
            <div id="read" class="section">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>Read merupakan salah satu operasi dari CRUD untuk membantu pengguna untuk mengambil atau mengakses data yang ada dari database, 
            ...
            <div id="update" class="section">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>Update memungkinkan pengguna untuk mengubah atau mengedit data yang ada di database. Operasi Update digunakan untuk memperbarui data 
            ...
            <div id="delete" class="section">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>Fungsi Delete memberi akses ke pengguna untuk menghapus data yang tidak diinginkan dari database. Operasi Delete digunakan untuk 
            ...
            <div id="sorting" class="section">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>Fitur sorting pada UB Guesthouse Banquet System berfungsi untuk mengatur urutan data pemesanan berdasarkan kriteria tertentu 
            ...
            <div id="searching" class="section">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>Fitur searching pada UB Guesthouse Banquet System memungkinkan pengguna untuk mencari data pemesanan berdasarkan berbagai 
            ...
            <div id="rekap" class="section">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>Fitur rekap pada UB Guesthouse Banquet System berfungsi untuk menyajikan ringkasan data pemesanan yang berguna untuk analisis
            ...
            <div id="history" class="section">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <p>Fitur history pada UB Guesthouse Banquet System berfungsi untuk mencatat dan menampilkan riwayat perubahan dan aktivitas yang 
